...
def analyze_drawdowns(n_clicks, stored_data, min_drawdown_pct, custom_value):
    ...
    try:
        ...
        # Create drawdown visualization graph
        fig = go.Figure()
        ...
        # Add shaded regions for each drawdown episode
...
#     prevent_initial_call=True
# )
# def analyze_drawdowns(n_clicks, stored_data, min_drawdown_pct):
#     if not stored_data or n_clicks == 0:
#         return html.Div()
...
#             events_df = events_df[events_df["drawdown_pct"].abs() * 100 >= min_drawdown_pct]
        
#         if events_df.empty:
#             return html.Div(f"No drawdowns found with magnitude ≥{min_drawdown_pct}%", 
#                           style={"color":"rgba(255,255,255,0.7)", "padding":"20px"})
...
#                     "marginBottom":"16px"
#                 }),
#                 html.P(f"Showing {len(display_df)} episode(s) with drawdown ≥{min_drawdown_pct}%", style={
#                     "fontSize":"14px", "color":"rgba(255,255,255,0.6)", "marginBottom":"16px"
#                 }),
#                 table,
#                 # Store data for download
