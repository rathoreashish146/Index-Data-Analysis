    ...
    return html.Div(
        [
            html.Div([
                ...
                html.P("Choose a workflow to begin your analysis:", style={
                    "fontSize":"18px", "color":"rgba(255,255,255,0.9)", "marginBottom":"40px"
                }),
            ], style={"textAlign":"center", "marginBottom":"48px"}),
            html.Div(
                [
...
def single_layout():
    return html.Div([
        html.Div([
            ...
            html.Div([
                html.P([
                    ...
                    "Upload a CSV with two columns: a date column and a numeric index column (headers can be anything)."
                ], style={
                    "fontSize":"16px", "color":"rgba(255,255,255,0.9)", "marginBottom":"0", "display":"inline-block"
                }),
            ], style={"marginBottom":"32px"}),
        ]),
        ...
        dcc.Upload(
            id="uploader",
            children=html.Div([
                html.Div("Drag and Drop or ", style={"fontSize":"16px", "color":"rgba(255,255,255,0.7)"}),
                html.A("Select CSV File", style={"fontSize":"16px", "color":"#00d4aa", "fontWeight":600, "textDecoration":"underline"})
            ]),
            style={
                "width":"100%","height":"100px",
                "borderWidth":"2px","borderStyle":"dashed","borderColor":"rgba(255,255,255,0.2)",
                "borderRadius":"16px","textAlign":"center","margin":"10px 0",
        ...
        html.Div([
            ...
            dcc.Checklist(
                ...
                labelStyle={
                    "display": "inline-block", "marginRight": "24px",
                    "fontSize":"15px", "color":"rgba(255,255,255,0.9)", "cursor":"pointer"
                },
            ),
        ], style={
            "marginBottom": "24px", "padding":"20px",
        ...
        html.Div([
            html.Div([
                html.H2("Drop Analysis", style={
                    "fontSize":"28px", "fontWeight":700, "color":"#ff6b6b",
                    "marginBottom":"20px"
                }),
                html.Div(id="analysis-output-drop", style={
                    "border": "2px solid #fee2e2", "borderRadius": "16px",
            ...
            html.Div([
                html.H2("Gain Analysis", style={
                    "fontSize":"28px", "fontWeight":700, "color":"#51cf66",
                    "marginBottom":"20px"
                }),
                html.Div(id="analysis-output-gain", style={
                    "border": "2px solid #dcfce7", "borderRadius": "16px",
    ...
    return html.Div(
        [
            html.Div([
                ...
                html.P("Compare two indexes side by side with correlation analysis", style={
                    "fontSize":"16px", "color":"rgba(255,255,255,0.9)", "marginBottom":"32px"
                }),
            ]),
            ...
            html.Div([
                html.Div([
                    html.Div([
                        html.H3("Upload Index A (CSV)", style={
                            "fontSize":"20px", "fontWeight":600, "color":"#ffffff",
                            "marginBottom":"16px", "display":"inline-block", "marginRight":"8px"
                        }),
                        html.Span("📁", style={"fontSize":"20px", "verticalAlign":"middle"}),
                    ]),
                    dcc.Upload(
                        id="uploader-a",
                        children=html.Div([
                            html.Div("Drag & drop or ", style={"fontSize":"15px", "color":"rgba(255,255,255,0.7)"}),
                            html.A("Select CSV", style={"fontSize":"15px", "color":"#00d4aa", "fontWeight":600, "textDecoration":"underline"})
                        ]),
                        style={
                            "width":"100%","height":"100px",
                            "borderWidth":"2px","borderStyle":"dashed","borderColor":"rgba(255,255,255,0.2)",
